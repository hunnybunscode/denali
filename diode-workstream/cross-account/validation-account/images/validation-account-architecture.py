...
from diagrams.aws.network import NATGateway, InternetGateway, APIGateway
...
def create_validation_architecture():
    with Diagram("AFTAC Validation Account Architecture", 
        ...
        with Cluster("VPC"):
            ...
            with Cluster("Private Subnets"):
                ...
                ec2_imagebuilder = EC2("Image Builder")
        ...
        iam >> [lambda_presigner, lambda_dest_parser, lambda_object_tagger, lambda_transfer_result, ec2_validation]
