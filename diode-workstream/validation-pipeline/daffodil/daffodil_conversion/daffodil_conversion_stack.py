...
from aws_cdk import Aspects  # type: ignore
from aws_cdk import aws_ec2 as ec2  # type: ignore
from aws_cdk import aws_iam as iam  # type: ignore
from aws_cdk import aws_lambda as _lambda  # type: ignore
from aws_cdk import aws_logs as logs  # type: ignore
from aws_cdk import aws_s3 as s3  # type: ignore
from aws_cdk import aws_s3_notifications as s3n  # type: ignore
from aws_cdk import BundlingOptions  # type: ignore
from aws_cdk import CfnOutput  # type: ignore
from aws_cdk import CfnParameter  # type: ignore
from aws_cdk import DockerVolume  # type: ignore
from aws_cdk import Duration  # type: ignore
from aws_cdk import RemovalPolicy  # type: ignore
from aws_cdk import Stack  # type: ignore
from cdklabs.cdk_enterprise_iac import ConvertInlinePoliciesToManaged  # type: ignore
...
class DaffodilConversionStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.iam_prefix = CfnParameter(
            self,
            "IamPrefix",
            type="String",
            min_length=2,
            description="The customer prefix to be used for IAM policies.",
        )  # noqa: E501
        permissions_boundary = CfnParameter(
            self,
            "PermissionsBoundaryPolicyArn",
            type="String",
            min_length=1,
            description="The arn for permissions boundary.",
        )  # noqa: E501
        self.permissions_boundary = iam.ManagedPolicy.from_managed_policy_arn(
            self,
            "PermissionsBoundary",
            permissions_boundary.value_as_string,
        )  # noqa: E501
        ...
        self.parser_role = self.__create_daffodil_parser_role(
            managed_policies=lambda_basic_execution_roles,
        )
        ...
        input_bucket_name = CfnParameter(
            self,
            "InputBucket",
            description="The name of the Amazon S3 bucket where files to be processed by daffodil will be stored.",  # noqa: E501
        )
        ...
        output_bucket_name = CfnParameter(
            self,
            "OutputBucket",
            description="The name of the Amazon S3 bucket where successful daffodil transformed "  # noqa: E501
        ...
        vpc_subnet_ids = CfnParameter(
            ...
            "VpcSubnetIDs",
            default=(
                get_parameter("/platform/networking/vpc/default/subnet/private")
                if DEVELOPMENT
                else None
            ),
            type="List<AWS::EC2::Subnet::Id>",
            description="The list of private subnet IDs to use for the daffodil pipeline",  # noqa: E501
        )
        ...
        sns_error_topic_arn = CfnParameter(
            ...
            "SnsErrorTopicArn",
            default="",
            description="The optional ARN of the SNS topic to send error notifications to.",  # noqa: E501
        )

        enable_detailed_metrics = CfnParameter(
            self,
            "EnableDetailedMetrics",
            allowed_values=["true", "false"],
            default="false",
            description="Whether or not the more detailed custom CloudFormation metrics are enabled.",  # noqa: E501
        )
        ...
        parser_filter_suffix = CfnParameter(
            ...
            "ParserFilterSuffix",
            default=None,
            description="Optional - File suffix filter(s) as a comma-separated-value to apply to the "  # noqa: E501
            "Bucket event listener. If no filter prefix is provided, all files will be sent to the "  # noqa: E501
            "daffodil parser.",
        )
        ...
        self.archive_bucket_name = CfnParameter(
            ...
            "ArchiveBucket",
            default=None,
            description="Optional - The name of the Amazon S3 bucket where original files will be "  # noqa: E501
            "moved to from the Input Bucket after successful daffodil transformation. If no "  # noqa: E501
            "name is supplied, successful transformed files will just be deleted from the "  # noqa: E501
            "Input Bucket.",
        )

        # self.dead_letter_bucket = self.optional_bucket_from_context_param("dead-letter-bucket")  # noqa: E501
        dead_letter_bucket_name = CfnParameter(
            self,
            "DeadLetterBucket",
            description="Optional - The name of the Amazon S3 bucket where failed daffodil "  # noqa: E501
            "transformation will be stored. If no bucket name is provided, failed daffodil "  # noqa: E501
            "transformation files will remain in the Input Bucket",
        )
        self.dead_letter_bucket = s3.Bucket.from_bucket_name(
            self,
            "deadLetterBucket",
            bucket_name=dead_letter_bucket_name.value_as_string,
        )

        # Default to create precompile function unless context parameter for
        # schema-bucket is given to allow for dev running multiple stacks using the
        # same schema bucket (only one can have a bucket notification listener on it)
        ...
        #     cond_proxy_exist.logical_id, proxy.value_as_string, Aws.NO_VALUE).to_string()  # noqa: E501
        ...
        #     cond_no_proxy_exist.logical_id, no_proxy.value_as_string, Aws.NO_VALUE).to_string()  # noqa: E501
        # proxy_env = {
        ...
        content_types_file_key = CfnParameter(
            self,
            "ContentTypeFileKey",
            default="content-types.yaml",
            description="content-type file mapping s3 key, defaults to content-types.yaml",  # noqa: E501
        )
        ...
        if DEVELOPMENT:
            ...
            lambda_code_bucket_param = CfnParameter(
                self,
                "LambdaCodeBucket",
                description="The name of the Amazon S3 bucket where uploaded code will be stored.",  # noqa: E501
            )
            ...
            parser_lambda_code_param = CfnParameter(
                self,
                "ParserLambdaCodeKey",
                default="parser.jar",
                description="The S3 key of the parser code in the code bucket (including prefixes).",  # noqa: E501
            )

            precompiler_lambda_code_param = CfnParameter(
                self,
                "PrecompilerLambdaCodeKey",
                default="precompiler.jar",
                description="The S3 key of the precompiler code in the code bucket (including prefixes)",  # noqa: E501
            )
        ...
        self.parser_fn.node.default_child.vpc_config = (
            _lambda.CfnFunction.VpcConfigProperty(
        ...
        if self.create_precompile_fn:
            ...
            self.precompiler_fn.node.default_child.vpc_config = (
                _lambda.CfnFunction.VpcConfigProperty(
                    security_group_ids=[lambda_security_group.attr_group_id],
                    subnet_ids=vpc_subnet_ids.value_as_list,
                )
        ...
        Aspects.of(self).add(
            ...
            #     instance_profile_prefix=self.iam_prefix.value_as_string + namespace.value_as_string,  # noqa: E501
            #     policy_prefix=self.iam_prefix.value_as_string + namespace.value_as_string,  # noqa: E501
            #     role_prefix=self.iam_prefix.value_as_string + namespace.value_as_string,  # noqa: E501
            # )
    ...
    def get_bundling_options(self, module_name) -> BundlingOptions:
        return BundlingOptions(
            command=[
                "/bin/sh",
                "-c",
                f"cd {module_name} && mvn clean install && cp /asset-input/{module_name}/target/{module_name}.jar /asset-output/",  # noqa: E501
            ],
            image=_lambda.Runtime.JAVA_11.bundling_image,
            volumes=[
                # Mount local .m2 repo to avoid downloading all the dependencies
    ...
    def optional_bucket_from_context_param(
        self,
        param_name: str,
        default_bucket_options: Optional[dict] = None,
    ) -> s3.Bucket:
        default_bucket_options = (
            default_bucket_options
            if default_bucket_options is not None
            else self.default_bucket_options
        )
        bucket_name = self.node.try_get_context(param_name)
        bucket = (
            s3.Bucket.from_bucket_name(self, param_name, bucket_name=bucket_name)
            if bucket_name is not None
            else s3.Bucket(self, param_name, **default_bucket_options)
        )
        CfnOutput(self, f"o{param_name}", value=bucket.bucket_name)
        return bucket

    def __create_daffodil_parser_role(
        self,
        *,
        managed_policies: Sequence[iam.IManagedPolicy],
    ):
        role = iam.Role(
            self,
            "DaffodilParserRole",
            assumed_by=iam.ServicePrincipal(self.lambda_endpoint),
            role_name="Daffodil_Parser_Role",
        ...
        role.add_managed_policy(
            policy=iam.ManagedPolicy(
                ...
                managed_policy_name="DaffodilParserPolicy",
                document=iam.PolicyDocument(
                    statements=[
                        ...
                        iam.PolicyStatement(
                            ...
                            resources=[
                                f"arn:{self.partition}:sns:{self.region}:{self.account}:*",  # noqa: E501
                            ],
                        ),
                    ],
                ),
