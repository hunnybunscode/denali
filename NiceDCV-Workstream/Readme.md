...
1. In the Account were DCV workstation solution will be deployed:
   1. Create an S3 bucket 
   2. Download DCV resources from highside buckets and store locally in S3 abucket above
   3. Download the SCAP bundle and benchmarks and store at the root of the S3
   4. Download the Stig "LinuxAWSConfigureSTIG_2025_Q1_3.tgz" and store at the root of the S3
